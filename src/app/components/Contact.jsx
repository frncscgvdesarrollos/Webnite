    ...
    return (
        <div className="h-[145vh] md:h-[900px] bg-blue-500 contact-container p-10">
            ...
            <div className='flex flex-col lg:items-center lg:justify-center md:flex-row gap-[15%] mt-10 mx-2 md:p-10'>
                <form
                    className="h-[500px] w-full lg:w-[500px] mr-10 md:ml-10 -rotate-6 shadow-yourdear border-l-4 border-b-4 border-white flex flex-col items-center justify-center h-fit bg-blue-600 rounded-lg p-6 space-y-4"
