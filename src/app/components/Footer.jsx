        ...
        <footer className="bg-gray-900 flex flex-col md:flex-row relative w-full h-auto md:h-[500px] p-6 md:p-0">
            <div className="flex flex-col justify-center w-full gap-4 items-center md:items-start md:ml-10">
                <div className="flex flex-col md:flex-row items-center gap-2 my-10 md:justify-start">
                    <Image src="/logoWebnite.png" alt="e" width={300} height={300} className="w-[100px] h-[100px]" />
                ...
                <div className="flex flex-wrap justify-center md:justify-start mt-5 gap-4">
                    ...
                    <Image src="/instagram.jpg" alt="b" width={300} height={300} className="w-[50px] h-[50px] border-b-2 border-violet-700 transition hover:text-yellow-200 rounded-lg shadow-yourdear" />
                    <Image src="/whasap.jpeg" alt="c" width={300} height={300} className="w-[50px] h-[50px] border-b-2 border-green-700 transition hover:text-yellow-200 rounded-lg shadow-yourdear" />
                </div>
            </div>
